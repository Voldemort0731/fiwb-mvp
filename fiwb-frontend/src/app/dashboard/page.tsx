...
export default function Dashboard() {
    ...
    useEffect(() => {
        ...
        courses.forEach(c => {
            if (c.name.toLowerCase().includes(query) || (c.professor && c.professor.toLowerCase().includes(query))) {
                results.push({ type: 'course', id: c.id, title: c.name, subtitle: 'Course', icon: GraduationCap });
            }
        });
    ...
    }, [searchQuery, courses, router, toggleTheme]);
            ...
            <main className="max-w-[1400px] mx-auto pt-28 pb-20 px-6 space-y-10 relative">
                        ...
                        <div className="flex flex-col items-center text-center space-y-8 max-w-2xl mx-auto">
                            ...
                            <div className="relative w-full group">
                                <input
                                    ...
                                    placeholder="Search Drive, Classroom..."
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 relative z-10">
                    ...
                    <motion.section
                        ...
                        className="lg:col-span-6 bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 rounded-[2.5rem] flex flex-col overflow-hidden shadow-xl"
                    >
                    ...
                    >
                        ...
                        <div className="bg-gradient-to-br from-blue-600 to-indigo-600 rounded-[2.5rem] p-8 text-white shadow-2xl shadow-blue-600/20 relative overflow-hidden group">
                            ...
                            <div className="relative z-10 space-y-4">
                                ...
                                <h3 className="text-xl font-black leading-tight">Sync complete. Your repository is up to date.</h3>
