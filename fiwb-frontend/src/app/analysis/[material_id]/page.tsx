...
import {
    ...
    Search, Calendar, MoreVertical, RefreshCw, Paperclip
} from "lucide-react";
        ...
        const fetchMaterial = async () => {
            try {
                ...
                if (messages.length === 0) {
                    const docName = firstDoc ? firstDoc.title : data.title;
                ...
                <div className="flex-1 flex overflow-hidden">
                    ...
                    <div className="w-[500px] flex flex-col bg-[#050505] relative shadow-2xl z-10">
                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-8 scrollbar-premium" ref={scrollRef}>
                            ...
                            {streaming && (
                                <div className="flex items-center gap-2 text-blue-500 px-2 mt-4">
...
export default function AnalysisPage() {
    return (
        <Suspense fallback={<div className="h-screen bg-[#050505] flex items-center justify-center text-blue-500 font-bold animate-pulse">INIT...</div>}>
            <AnalysisBody />
        </Suspense>
    );
}
